...
func (c *Cache) SaveMessage(ctx context.Context, msg *model.Notice, ttl time.Duration) error {
...
func (c *Cache) GetMessage(ctx context.Context, id int) (*model.Notice, error) {
...
func (c *Cache) GetAllMessages(ctx context.Context) ([]model.Notice, error) {
	keys, err := c.DB.Keys(ctx, "message:*").Result()
	if err != nil {
		return nil, err
	}

	var messages []model.Notice
