...
import (
	...
	db "github.com/Khmelov/Distcomp/251003/truhan/lab1/internal/storage/topic"
)
...
func (s *service) Create(ctx context.Context, req model.Topic) (model.Topic, error) {
	return s.db.Create(ctx, req)
}

func (s *service) GetList(ctx context.Context) ([]model.Topic, error) {
	return s.db.GetList(ctx)
}

func (s *service) Get(ctx context.Context, id int64) (model.Topic, error) {
	return s.db.Get(ctx, id)
}

func (s *service) Update(ctx context.Context, req model.Topic) (model.Topic, error) {
