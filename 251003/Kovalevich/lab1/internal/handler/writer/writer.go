...
import (
	...
	"encoding/json"
	"errors"
	authorErr "github.com/Khmelov/Distcomp/251003/truhan/lab1/internal/storage/writer"
	"net/http"
	"strconv"
...
func (c Handler) InitRoutes(r *mux.Router) {
	...
	r.HandleFunc("/writers", c.create).Methods(http.MethodPost)
...
func (c Handler) delete(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, authorErr.ErrWriterNotFound) {
