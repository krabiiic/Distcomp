...
public class IssueService {
    ...
    private final MarkerService markService; // Добавить
    ...
    public IssueService(IssueRepository issueRepository,
                        ...
                        MarkerService markService,
                        IssueMarkRepository issueMarkRepository, MarkerRepository markRepository) {
    ...
    public IssueResponseTo createIssue(IssueRequestTo request) {
        ...
        if (request.getMarks() != null) {
            for (String markName : request.getMarks()) {
                Marker mark = markService.findOrCreateMark(markName);
