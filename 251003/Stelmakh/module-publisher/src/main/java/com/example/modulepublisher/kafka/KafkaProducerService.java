package com.example.modulepublisher.kafka;
...
public class KafkaProducerService {
    ...
    public void sendMessage(String topic, ReactionDTO message) {
        kafkaTemplate.send(MessageBuilder.withPayload(message)
                .setHeader(KafkaHeaders.TOPIC, topic)
                .setHeader(KafkaHeaders.MESSAGE_KEY,message.getIssueId())
                .build());
    }
